...
from pegasus.config.settings import COLORS, EXPORT_DIR
...
def detect_operator(phone_number):
    ...
    from pegasus.config.settings import PHONE_OPERATORS
...
def generate_email(name):
    ...
    import random
    from pegasus.config.settings import EMAIL_DOMAINS
...
def generate_social_media(name):
    ...
    import random
    from pegasus.config.settings import SOCIAL_MEDIA_PLATFORMS
