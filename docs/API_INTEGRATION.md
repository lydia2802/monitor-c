...
echo "pegasus/config/api_config.py" >> .gitignore
...
**Solution**: Check your API key in `pegasus/config/api_config.py`
...
### Code Examples
- `pegasus/config/api_config.example.py` - Configuration example
