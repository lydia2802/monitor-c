...
def test_imports():
    ...
    try:
        from pegasus.config.api_config import API_ENABLED, API_KEYS, API_ENDPOINTS
    ...
    try:
        from pegasus.utils.api_client import APIClient, perform_real_lookup, RateLimiter
    ...
    try:
        from pegasus.utils.api_client import DatabaseClient, result_cache
...
def test_api_client():
    ...
    try:
        from pegasus.utils.api_client import APIClient
...
def test_rate_limiter():
    ...
    try:
        from pegasus.utils.api_client import RateLimiter
...
def test_cache():
    ...
    try:
        from pegasus.utils.api_client import result_cache
...
def test_database_client():
    ...
    try:
        from pegasus.utils.api_client import DatabaseClient
        from pegasus.config.api_config import DATABASE_ENABLED
...
def test_normalize_response():
    ...
    try:
        ...
        from pegasus.main import normalize_api_response
